    ...
    return (
        <div className="w-full">
            <div className="flex items-center justify-center my-6 w-full">
                <div className="flex justify-evenly space-x-4 w-7/12 items-center">
            ...
            <div className=" my-6 flex items-center justify-center">
                <div className="w-11/12 md:w-8/12 lg:w-7/12">
                    ...
                    <div className="flex flex-col items-center">
                        <h2 className="text-xl md:text-3xl lg:text-5xl font-bold text-center my-2">Everything you need for visual collaboration</h2>
                        <p className="w-10/12 md:w-7/12 lg:w-6/12  text-md text-center my-2">TurboDraw combines intuitive drawing tools with powerful collaboration features to transform how your team works together.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-center items-center my-6">
                <div className="w-11/12 md:w-9/12 lg:w-10/12 grid grid-cols-3 gap-8 my-6">
                    {FEATURES.map(ft => {
